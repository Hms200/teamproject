          ...
          <div class="row no-gutters my-0">
        	<c:forEach var="review_img" items="${ reviewimgslist }">
	          ...
	          <div class="card-body col-8 py-2 "> 
	            <p class="card-text d-flex text-black-50 mb-1" style="font-size: 10px;"><span>★ ${ review.review_star }</span><span class="text-right" style="float: right;">${ review.review_date }</span></p>
