	...
	<div
		...
		<div
			...
			<div class="col-1 my-3">
				<a href="/customer"> <img src="/img/icon/뒤로가기 (2).png" alt=""
		...
		<form action="userSearchAction" name="userSearchForm">
			...
			<div class="d-flex flex-row mt-4 mb-4">
				<div class="form-control" style="width: 90px;">
					<select class="form-select " aria-label="문의종류" value="문의종류"
				...
				<form class="d-flex">
					<div class="search">
						<input type="search" placeholder="Search" aria-label="Search"
							class="border border-1 form-control" style="width: 230px;">
					</div>
					<div>
						<button type="submit">
			...
			<table class="table table-bordered table-sm text-dark">
				...
				<tbody style="font-size: 12px;">
					...
					<tr style="cursor: pointer;"
						onclick="popupHideandShow(target='memberlistpopup')">
						<td>01</td>
						<td>hong1234</td>
						<td>홍길동</td>
						<td>12</td>
