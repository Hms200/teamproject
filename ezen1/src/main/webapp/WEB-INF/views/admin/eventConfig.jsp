    ...
    <div class="container-sm container-fluid d-flex flex-column justify-content-center align-items-center postion-relative px-0" style="max-width: 520px;">
         ...
         <div class="container-fluid d-flex flex-row mb-4 border-bottom border-dark-50" style="height: 60px; margin-top: 60px;">
            ...
            <div class="container-fluid form-group col-11">
                <form class="w-100 d-flex flex-row position-relative" name="adminStockForm" method="get" action="mainSearchAction">
                    <select class="custom-select custom-select-lg col-3" name="stock_cat">
                        ...
                        <option value="goods_onevent">진행중인 이벤트</option>
                    </select>
                    <input class="form-control form-control-lg col-9" type="text" placeholder="검색">
            ...
            <!-- 상품리스트 카드 영역 -->
            <form class="w-100" name="productManagementForm">
                ...
                <div class="col-12 d-flex flex-row justify-content-around text-center mt-5 mb-3" style="line-height: 30px;">
